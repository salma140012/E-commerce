    ...
    <div class="small-container cart-page">
                    ...
                    <div class="cart-info">
                           ...
                           <img src="../uploaded_img/<?php echo $fetch_cart['image']; ?>" height="100" alt="">
                            <div class="infoo">
                                ...
                                <br>
                                <a href="../user/cartpage.php?remove=<?php echo $fetch_cart['id']; ?>" class="delete-btn" onclick="return confirm('remove item from cart?');"><i class="fa fa-trash-o"></i><b> Remove</b></a>
        ...
        <div class="total-price">
            ...
            <table>
                ...
                <tr> <td colspan="2"><a href="../user/checkout.php" class="btn <?php echo ($grand_total > 1)?'':'disabled'; ?>">proceed to checkout</a></td></tr>
                <tr> <td colspan="2"><a href="../user/homepage.php" class="btn <?php echo ($grand_total > 1)?'':'disabled'; ?>">Continue Shopping</a></td></tr>
            </table>
